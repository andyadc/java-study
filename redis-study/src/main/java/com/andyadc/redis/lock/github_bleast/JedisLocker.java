package com.andyadc.redis.lock.github_bleast;
...
public class JedisLocker {
     ...
     * @param key                 锁的key值
     * @param val                 锁的value值
     * @param expireMilliseconds  锁失效时间, null表示永不失效
     * @param tryLockMilliseconds 如果获取锁失败,多久后重试
     * @param timeoutMilliseconds 获取锁的最大等待时间, null表示一直等待
